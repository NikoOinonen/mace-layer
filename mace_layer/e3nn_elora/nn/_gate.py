...
class Gate(torch.nn.Module):
    ...
    def __init__(self, irreps_scalars, act_scalars, irreps_gates, act_gates, irreps_gated, r_lora=None) -> None:
        super().__init__()
        ...
        self.mul = ElementwiseTensorProduct(irreps_gated, irreps_gates, r_lora=r_lora)
